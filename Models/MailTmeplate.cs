namespace BASE.Models
{
    public class MailTmeplate
    {
        ...
        {
            //報名成功
            public static String REGISTER_SUCCESS_SUBJECT = "【報名完成待審核】勞動部勞動力發展署桃竹苗分署-{0}{1}";
            public static String REGISTER_SUCCESS_CONTNET = @"
                <p><B>(本郵件由系統自動寄發，請勿直接回覆此郵件)</B></p>
                
                <p>{0} 您好</p>
                <p>已收到您的報名資訊，{3}{1}課程，請注意收到此封信不代表您的報名已錄取，主辦單位保留參加資格審核之權利，我們將會審核您的報名資料，請隨時留意審核結果通知信。 </p>
                <p>本活動資訊如下<br />
                活動主題：「{1}-{2}」<br />
                活動日期：{6}<br />
                報名結果：待審核中<br />
